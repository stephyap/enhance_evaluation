---
title: "Q1 - Beyond Blue Data Preprocessing"
---
...
# Import datasets
```{r}
main <- readxl::read_xlsx("/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Data/2021-07-21/Evaluation Data Collection Plan-Collin-Beyond Blue.xlsx", sheet=2)

aggregate <- readxl::read_xlsx("/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Data/2021-07-21/Evaluation Data Collection Plan-Collin-Beyond Blue.xlsx", sheet=3)

referrals <- readxl::read_xlsx("/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Data/2021-06-21/Beyond Blue Referrals.xlsx")
```
...
main$screening_date       <- as.Date(main$screening_date)
main$assessments_date_3   <- as.Date(main$assessments_date_3)
...
```{r}
# assessment_date_0
main$assessments_date_0 <- gsub(",.*$", "", main$assessments_date_0)
main$assessments_date_0 <- as.Date(main$assessments_date_0, "%m/%d/%Y")
```

```{r}
# needs_assessment_0 
main$needs_assessment_date_0 <- excel_numeric_to_date(as.numeric(as.character(main$needs_assessment_date_0), date_system = "modern"))
```
...
aggregate <- aggregate[!is.na(aggregate$"Aggregate Measures"),]
```

```{r}
aggregate <-
  aggregate %>% rename(
  aggregate_measures = "Aggregate Measures",
  jan_2021 = "44197",
  feb_2021 = "44228",
  mar_2021 = "44256", 
  apr_2021 = "44287", 
...
```{r}
# wide datasets
# readr::write_csv(main, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/wide datasets/q1_beyondblue_data_collection_07212021.csv")
# 
# readr::write_csv(referrals, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/wide datasets/q1_beyondblue_referrals_07212021.csv")
```
...
rm(needs_assessment_date, needs_ass_status, needs_ass_date_long, need1, need2, need3, need4, need5, need6, need1_yn, need1_yn_long, need2_yn, need2_yn_long, need3_yn, need3_yn_long,  need4_yn, need4_yn_long,  need5_yn, need5_yn_long, need6_yn, need6_yn_long, n_occur )
```
...
```{r}
# long datasets
readr::write_csv(demo, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_demo_07212021.csv")

readr::write_csv(program_status, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_program_status_07212021.csv")

readr::write_csv(needs_assessment, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_needs_assessment_07212021.csv")

readr::write_csv(referrals, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_referrals_07212021.csv")

readr::write_csv(assessments, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_assessments_07212021.csv")

readr::write_csv(aggregate, "/Users/cyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/LifePath Systems/Analysis/Steph/long datasets/q1_beyondblue_aggregate_07212021.csv")
```
