...
```{r}
demo <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/THR Evaluation Team Version Evaluation Data Collection Plan-TarrantParker-Project HHH August 2021.xlsx", sheet=2)

usda <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/USDA March-August 2021.xlsx")

gse <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/GSE March-Augus 2021.xlsx")

grocery <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/Grocery Log March-August 2021.xlsx")

sh_voucher <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/Safe Harbor Vouchers March-August 2021.xlsx")

steps <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/STEPS Class Attenance March-August 2021.xlsx")

aggregate <- readxl::read_xlsx("/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Data/2021-09-10/THR Evaluation Team Version Evaluation Data Collection Plan-TarrantParker-Project HHH August 2021.xlsx", sheet=3)
```
...
demo$referred_steps[demo$participant_id=="39241"] <- "yes"
demo <- demo %>% select(-c(starts_with("needs")))
usda <- usda %>% select(-c(touch_point_name, subject_type, a_9_total_score))
gse <- gse %>% select(-c(touch_point_name, subject_type, c_1_total_score ))
grocery <- grocery %>% select(-c(touch_point_name, subject_type))
sh_voucher <- sh_voucher %>% select(-c(touch_point_name, subject_type))
steps <- steps %>% select(-c(touch_point_name, subject_type))
```
...
```{r}
dput(as.character(colnames(grocery)))
```
...
usda <- usda %>% mutate(
  ...
  usda_ad1 = a_4_ad1_in_the_last_12_months_did_you_or_other_adults_in_your_household_ever_cut_the_size_of_your_meals_or_skip_meals_because_there_wasnt_enough_money_for_food,
  usda_ad1a = a_6_ad1a_if_yes_above_ask_how_often_did_this_happen_almost_every_month_some_months_but_not_every_month_or_in_only_1_or_2_months,
  usda_ad2 = a_7_ada2_in_the_last_12_months_did_you_ever_eat_less_than_you_felt_you_should_because_there_wasnt_enough_money_for_food,
  usda_ad3 = a_8_ad3_in_the_last_12_months_were_you_ever_hungry_but_didnt_eat_because_there_wasnt_enough_money_for_food,
  usda_site = site,
...
gse <- gse %>% mutate(
  ...
  gse_1  = b_1_i_can_always_manage_to_solve_difficult_problems_if_i_try_hard_enough,
  gse_2  = b_2_if_someone_opposes_me_i_can_find_the_means_and_ways_to_get_what_i_want, 
  gse_3  = b_3_it_is_easy_for_me_to_stick_to_my_aims_and_accomplish_my_goals,
  gse_4  = b_4_i_am_confident_that_i_could_deal_efficiently_with_unexpected_events,
  gse_5  = b_5_thanks_to_my_resourcefulness_i_know_how_to_handle_unforeseen_situaitons,
  gse_6  = b_6_i_can_solve_most_problems_if_i_invest_the_necessary_effor,
  gse_7  = b_7_i_can_remain_calm_when_facing_difficulties_because_i_can_rely_on_my_coping_abilities,
  gse_8  = b_8_when_i_am_confronted_with_a_problem_i_can_usually_find_several_solutions,
  gse_9  = b_9_if_i_am_in_trouble_i_can_usually_think_of_a_solution,
  gse_10 = b_10_i_can_usually_handle_whatever_comes_my_way
...
) %>% select(participant_id, steps_program, steps_response_date, steps_location_of_service, steps_attendance, steps_time_spent, steps_activity)
...
demo <- demo[order(demo$participant_id, demo$initial_intake_date), ] # 137 records 
usda <- usda[order(usda$participant_id, usda$usda_response_date), ] # 128 records 
gse <- gse[order(gse$participant_id, gse$gse_response_date), ] # 86 records
grocery <- grocery[order(grocery$participant_id, grocery$grocery_response_date), ] # 257 records
sh_voucher <- sh_voucher[order(sh_voucher$participant_id, sh_voucher$sh_voucher_response_date), ] # 27 records
steps <- steps[order(steps$participant_id, steps$steps_response_date), ] # 4 records
...
demo <- demo %>% naniar::replace_with_na_all(condition= ~.x %in% na_strings)
...
```{r}
steps <- demo %>% filter(referred_steps == "yes") %>% select(
  participant_id, enrollment_date_steps, gse_date_steps_0, 
  gse_score_steps_0, gse_date_steps_3, gse_score_steps_3, 
  gse_date_steps_6, gse_score_steps_6, gse_date_steps_9, 
  gse_score_steps_9, gse_date_steps_12, gse_score_steps_12)

steps$gse_date_steps_0 <- as.Date(steps$gse_date_steps_0)
steps$gse_date_steps_3 <- as.Date(steps$gse_date_steps_3)
steps$gse_date_steps_6 <- as.Date(steps$gse_date_steps_6)
steps$gse_date_steps_9 <- as.Date(steps$gse_date_steps_9)
steps$gse_date_steps_12 <- as.Date(steps$gse_date_steps_12)
steps$gse_score_steps_0 <- as.integer(steps$gse_score_steps_0)
steps$gse_score_steps_3 <- as.integer(steps$gse_score_steps_3)
steps$gse_score_steps_6 <- as.integer(steps$gse_score_steps_6)
steps$gse_score_steps_9 <- as.integer(steps$gse_score_steps_9)
steps$gse_score_steps_12 <- as.integer(steps$gse_score_steps_12)

steps_gse_score <- steps %>% select(participant_id, enrollment_date_steps, contains("gse_score_steps"))
steps_gse_score_long <- steps_gse_score %>% 
  pivot_longer(
    cols         = starts_with("gse_score_steps_"),
    names_to     = "timepoint",
    names_prefix = "gse_score_steps_",
    values_to    = "gse_score"
  )
steps_gse_date <- steps %>% select(participant_id, enrollment_date_steps, contains("gse_date_steps"))
steps_gse_date_long <- steps_gse_date %>% 
  pivot_longer(
    cols         = starts_with("gse_date_steps_"),
    names_to     = "timepoint",
    names_prefix = "gse_date_steps_",
    values_to    = "gse_date"
  )

steps <- steps_gse_score_long %>% 
  left_join(steps_gse_date_long, by = c("participant_id"="participant_id", "timepoint"="timepoint", "enrollment_date_steps"="enrollment_date_steps"))

rm(steps_gse_score, steps_gse_date, steps_gse_score_long, steps_gse_date_long)
```
...
demo$enrollment_date <- demo$enrollment_date %>% 
  as.numeric(demo$enrollment_date)
demo$enrollment_date <- as.Date(demo$enrollment_date, origin="1899-12-30")
```

```{r}
dput(as.character(colnames(aggregate)))
```

```{r}
# long versions
readr::write_csv(calm, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_calm_long_09102021.csv")

readr::write_csv(demo, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_demo_long_09102021.csv")

readr::write_csv(grocery, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_grocery_long_09102021.csv")

readr::write_csv(gse, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_gse_long_09102021.csv")

readr::write_csv(sh_voucher, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_sh_voucher_long_09102021.csv")

readr::write_csv(steps, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_steps_long_09102021.csv")

readr::write_csv(usda, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_usda_long_09102021.csv")

readr::write_csv(safe_harbor, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_safe_harbor_long_09102021.csv")

readr::write_csv(job_training, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_job_training_long_09102021.csv")

readr::write_csv(food_security, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_food_security_long_09102021.csv")

readr::write_csv(program_status, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_program_status_long_09102021.csv")

# readr::write_csv(aggregate, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/long datasets/q2/q2_hhh_aggregate_long_09102021.csv")
```
...
```{r}
# wide version
readr::write_csv(q1_hhh_wide, "/Users/chiufengyap/The University of Texas Health Science Center at Houston/SPH THCI Eval - General/Data Collection/Quantitative/Center of Hope/Analysis/Steph/wide datasets/q1_hhh_wide_07072021.csv")
```
